...
public class fee extends JFrame { 
	...
	{ 
		...
		l10.setBounds(50, 450, 250, 30); 

		tf6 = new JTextField(); 
		tf6.setBounds(250, 450, 250, 30); 

		l11 = new JLabel( 
			"Year of passing 10th"); 
		l11.setBounds(50, 500, 250, 30); 
		...
		cb1.setBounds(250, 500, 90, 30); 

		l12 = new JLabel( 
			"Year of passing 12th"); 
		l12.setBounds(50, 550, 250, 30);
		...
		l8.setBounds(600, 100, 150, 35); 

		rb1 = new JRadioButton("SEAS"); 
		rb1.setBounds(750, 100, 100, 30); 

		rb2 = new JRadioButton("SLABS"); 
		rb2.setBounds(850, 100, 100, 30); 
		...
		rb3.setBounds(750, 150, 100, 30); 

		rb4 = new JRadioButton("DAY SCHOLAR"); 
		rb4.setBounds(850, 150, 120, 30); 
                
                l81 = new JLabel( 
			"Select:"); 
		l81.setBounds(600, 150, 150, 30);
		...
		cb.setBounds(750, 200, 90, 30); 
                
                l82 = new JLabel( 
			"Select:"); 
		l82.setBounds(600, 200, 150, 30);
		...
		final JLabel label 
			= new JLabel(); 
		label.setBounds(600, 385, 600, 30); 
                l83 = new JLabel( 
			"Fee :"); 
		l83.setBounds(600, 275, 150, 30);
		JButton b = new JButton("Show"); 
		b.setBounds(1100, 350, 80, 30); 
		...
		list1.setBounds(750, 250, 125, 125); 
		...
		Receipt.setBounds(600, 420, 150, 30); 
		JButton b2 = new JButton("Reset"); 
		b2.setBounds(750, 420, 150, 30); 
		JButton Print = new JButton("Print"); 
		Print.setBounds(900, 420, 150, 30); 

		area2 = new JTextArea(); 
		area2.setBounds(600, 450, 500, 300); 
				...
				if (index2 == 4) { 
					area2.setText(area2.getText() 
								...
								+ "is 2.9 Lakhs \n"); 
                                                                       ...
                                                                       //linking data entered to notepad
